...
type WebIntelligencePageClientProps = {
  initialSnapshot: WebsiteIntelligenceSnapshot | null;
};

export default function WebIntelligencePageClient({
  initialSnapshot,
}: WebIntelligencePageClientProps) {
  const [snapshot, setSnapshot] = React.useState<WebsiteIntelligenceSnapshot>(
    initialSnapshot ?? EMPTY_WEBSITE_INTELLIGENCE_SNAPSHOT
  );
