...
export function WebIntelligenceFeatureCard({
  ...
  return (
    <Link
      ...
      className="block h-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#00D4FF]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#07111f]"
    >
      <InteractiveGlowCard
        className={cn(
          "group relative h-full cursor-pointer overflow-hidden rounded-2xl border border-[#4f7ca7]/20 bg-[rgba(10,20,38,0.66)] shadow-[0_18px_44px_rgba(0,0,0,0.24)] transition-all duration-300 hover:-translate-y-0.5 hover:border-[#00D4FF]/35 hover:bg-[rgba(12,26,48,0.76)] hover:shadow-[0_20px_52px_rgba(0,212,255,0.12)]",
          className
        )}
      >
        ...
        <CardContent className="relative z-10 space-y-3 pt-0">
          ...
          <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#9eefff] transition-colors group-hover:text-white">
            {feature.ctaLabel}
